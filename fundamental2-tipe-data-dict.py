...
print('Data ini dikirimkan oleh server Gojek, untuk memberikan info driver disekitar pemakai aplikasi')
data_dari_server_gojek = {
    'tanggal': '2021-07-03',
    'driver_list': [{'nama': 'Eka', 'jarak':10}, {'nama': 'Dwi', 'jarak': '30'}, {'[nama': 'Tri', 'jarak': '100'}, {'nama': 'Catur','jarak': '1000'}]
